...
*(Incluir imagen o diagrama generado en otro archivo si aplica)*
...
### **Identificadores**
Se utiliza **UUID v4** en todas las tablas transaccionales para seguridad y escalabilidad.

### **Foreign Keys**
Integridad referencial fuerte (**RESTRICT/CASCADE**) en todas las relaciones principales.
